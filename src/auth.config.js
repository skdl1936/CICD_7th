...
export const googleStrategy = new GoogleStrategy(
    {
        ...
        callbackURL: "http://ec2-15-165-95-120.ap-northeast-2.compute.amazonaws.com:3000:3000/oauth2/callback/google",
        scope: ["email", "profile"],
        state: true,
    },
...
export const naverStrategy = new NaverStrategy(
    {
        ...
        callbackURL: "http://ec2-15-165-95-120.ap-northeast-2.compute.amazonaws.com:3000/oauth/naver/callback",
        scope: ["email", "profile"],
        state: true,
    },
    (accessToken, refreshToken, profile, cb) => {
